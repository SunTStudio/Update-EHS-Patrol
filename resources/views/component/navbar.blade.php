            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="text-muted text-xs block">{{ auth()->user()->detail->name ?? auth()->user()->name }}</span>
                        </a>
                    </div>
                ...
                <li class="@if($halaman == "Laporan") {{ 'active' }} @endif">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        @if(!auth()->user()->hasRole('Admin') && !auth()->user()->hasRole('Departement Head EHS') && !auth()->user()->hasRole('member'))
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <form action="{{url('logout')}}" method="post" id="logoutForm">
                        @csrf
                        <a href="{{ route('to.portal') }}" class="p-0 pt-2"><button type="button"
