...
class SettingController extends Controller
{
    ...
    public function pic_assign(Request $request){
        ...
        if($user->hasRole('PIC')){
            $validateData['role_id'] = $user->roles()->where('name', 'PIC')->pluck('id')->first();
        }elseif($user->hasRole('Departement Head PIC')){
            $validateData['role_id'] = $user->roles()->where('name', 'Departement Head PIC')->pluck('id')->first();
        }
    ...
    public function table_activity(Request $request){
        ...
        if ($request->ajax()){
            ...
            if (auth()->user()->hasRole('PIC') || auth()->user()->hasRole('Departement Head PIC')) {
