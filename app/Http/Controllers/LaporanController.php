...
class LaporanController extends Controller{
    ...
    public function create($id) {
        ...
        $PIC = user_has_area::where('area_id', $laporan->area_id)->where('role_id', $rolePIC->id)->first();
        ...
        if($validateData['rank'] == 'A'){
            ...
            $EHSandDepts = DB::table('model_has_roles as role')
                    ...
                    ->where(function ($query) {
                        ...
                        $query->where('role.role_id', $roleEHS->id)
                              ->orWhere('role.role_id', $roleDeptHeadEHS->id);
                    })
    ...
    public function destroy(Request $request){
        ...
        if($genba) {
            ...
            if ( !auth()->user()->hasAnyRole(['Departement Head EHS', 'EHS'])) {
